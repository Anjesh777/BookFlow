...
import { BookflowNotificationEditDialogComponent } from '../bookflow-notification-edit-dialog/bookflow-notification-edit-dialog.component';

@Component({
  selector: 'app-admin-notfication-edit-dilog',
  standalone: true,
...
export class AdminNotficationEditDilogComponent {
